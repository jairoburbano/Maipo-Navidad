...
require('config.php');
function _table_authorizer ($action, $database, $table) {
	global $config;
	if($table == $config['table_name']) {
        $allowed_actions = $config['allowed_actions'];
        // 'list', 'read', 'update', 'delete', 'headers', 'create'
...
$api = new PHP_CRUD_API(array(
	'dbengine'=>'MySQL',
	'hostname'=>'localhost',
	'username'=>'juegovinamaipo',
	'password'=> "N#G@j*SzSo/k>60bAuB_U'01967]6g",
	'database'=>'juegovinamaipo',
	'charset'=>'utf8',
    // Permissions
    'table_authorizer'  => _table_authorizer,
    // Allow origin
